...
{
    public partial class CallAdditionalInfo
    {
        [Inject]
        ...
        private AdditionalCallFilerModel model = new();
        ...
        private async Task MakeRequest()
        {
            var result = await CallApiClient.CallOperations.FilterCall(new FilterRequest
            {
                ...
                CallStatus = CallStatus.TransferedToBrigade,
            });
    ...
    class AdditionalCallFilerModel
    {
