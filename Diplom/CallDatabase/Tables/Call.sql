...
(
	...
	[AmbulanceBrigadeId] int null,
	[DispatcherId] int not null,
	[ResultId] int null,
	[DiagnosisId] int not null,
	[CallerId] int not null,
	[DateTimeReception] DATETIME2(2) not null,
	[TransferDateTime] DATETIME2(2) not null,
	[ArrivalDateTime] DATETIME2(2) not null,
	[DepartureDateTime] DATETIME2(2) not null,
	[ComebackDateTime] DATETIME2(2) not null,
	[TransferingDispatcherId] int NULL,
	[ProcessingDispatcherId] int null,
	[KilometrageBefore] int not null,
	[KilometrageAfter] int not null,
	[PlaceId] int null,
	[CallNotes] nvarchar(max) null,
